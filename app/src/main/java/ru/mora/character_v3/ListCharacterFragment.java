...
import ru.mora.character_v3.adapters.CharacterCardAdapter;
import ru.mora.character_v3.adapters.CharacterListAdapter;
...
public class ListCharacterFragment extends Fragment
    ...
    public interface OnClickAddButtonListener {
        ...
        void onButtonClickSee(int position);
    ...
    public void setCharacterList(int v) {
        if (v == 0) {
            ...
            CharacterListAdapter characterAdapter = new CharacterListAdapter(getContext(), characters);
